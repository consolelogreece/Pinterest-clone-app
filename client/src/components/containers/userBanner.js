			...
			<div className="banner-wrapper--mobile">
			  <div className="banner--mobile">
			    ...
			    <div className="pic-box--mobile">
			      <img className="picture-element--mobile" src={!props.userProfile.picture ? "https://i.imgur.com/xRped5d.png" : props.userProfile.picture} />
			    </div>
			...
			<div className="banner-wrapper">
			  <div className="banner">
			    ...
			    <div className="pic-box">
			      <img className="picture-element" src={!props.userProfile.picture ? "https://i.imgur.com/xRped5d.png" : props.userProfile.picture} />
			    </div>
